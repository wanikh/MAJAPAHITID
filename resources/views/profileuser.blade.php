                        ...
                        <div class="row gx-10 mb-3">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="niks"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="position-relative d-flex align-items-center w-200px">
                                        <input type="date" class="form-control form-control-transparent fw-bolder pe-5"
                                            placeholder="Select date" name="tanggallahirs" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="row gx-10 mb-3">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="position-relative d-flex align-items-center w-200px">
                                        <input type="date" class="form-control form-control-transparent fw-bolder pe-5"
                                            placeholder="Select date" name="tanggaljoins" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="kontrak"
                                        placeholder="Hitungan Dalam Bulan">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row gx-10 mb-3">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="bpjsketenagakerjaan"
                                        placeholder="Masukkan Nomor BPJS KETENAGAKERJAAN Anda">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="exampleFormControlInput1">BPJS KESEHATAN</label>
                                    <input type="text" class="form-control" name="bpjskesehatan"
                                        placeholder="Masukkan Nomor BPJS KESEHATAN Anda">
                                </div>
                            </div>
                        </div>
