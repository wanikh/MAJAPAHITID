                            ...
                            <div class="row justify-content-center">
                                <div class="col">
                                    ...
                                    <form action="{{ route('postlogin') }}" method="post">
                                        ...
                                        <div class="mb-3">
                                            <button type="submit"
                                                style="background: linear-gradient(90deg, #FF8A23 0%, #F09F13 100%);width: 100%;
                      margin: 0!important;"
                                                class="btn align-items-center">Log In</button>
                                        </div>
                                        <!-- /.col -->
                                        <div class="social-auth-links text-center mb-3">
                                            <p class="mb-1">
                                                <a href="forgot-password.html" style="color: black;">I forgot my
                                                    password</a>
                                            </p>
                                        </div>
                                </div>
