                ...
                <div class="col-lg-6">
                  <div class="form-group">
                      ...
                      <div class="position-relative d-flex align-items-center w-200px">
                        <input type="date" class="form-control form-control-transparent fw-bolder pe-5" placeholder="Select date" name="tanggallahir" value="">
                      </div> 
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <div class="position-relative d-flex align-items-center w-200px">
                      <input type="date" class="form-control form-control-transparent fw-bolder pe-5" placeholder="Select date" name="tanggalpengajuan" value="">
                    </div> 
                  </div>
                </div>
              </div>
